package io.plani.cafe.planicafe.common.config;

import io.plani.cafe.planicafe.security.filter.JwtAuthenticationFilter;
import io.plani.cafe.planicafe.security.handler.OAuth2AuthenticationFailureHandler;
import io.plani.cafe.planicafe.security.handler.OAuth2AuthenticationSuccessHandler;
import io.plani.cafe.planicafe.security.service.CustomOAuth2UserService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                 ...
                 *     → JWT 검증
                 *     → userId 추출
                 *     → DB 조회해 UserEntity 를 Authentication 에 세팅
                 *
